...
function PreferencesPanel({ preferences, setPreferences, urls , setUrls }) {
  ...
  const payload = {
    "prompt": preferences.promptText || "Woman in a surrealistic landscape",
    "negative_prompt": "",
    "style_selections": [
      "Fooocus V2",
      "Fooocus Enhance",
  ...
  const handleCreateImage = async() => {
    ...
    let completePrompt = preferences.promptText || "An artistic image";
    ...
    const res = await axios.post(`${host}/v1/generation/text-to-image`, updatedPayload, {
      headers : {
